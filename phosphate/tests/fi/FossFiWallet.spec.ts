...
import { randomAddress, getRandomTon, differentAddress, getRandomInt, testJettonInternalTransfer } from '../personal/utils';
import { Op, Errors } from '../../wrappers/constants';
import { calcStorageFee, collectCellStats, computeFwdFees, computeFwdFeesVerbose, FullFees, GasPrices, getGasPrices, getMsgPrices, getStoragePrices, computedGeneric, storageGeneric, MsgPrices, setGasPrice, setMsgPrices, setStoragePrices, StorageStats, StorageValue } from '../personal/gasUtils';
...
describe(numericFolder, () => {
    ...
    beforeAll(async () => {
        ...
        walletStats    = new StorageStats(1026, 3);
        ...
        stateInitStats = new StorageStats(812, 3);
        defaultContent = {
