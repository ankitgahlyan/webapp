                        ...
                        <div className='flex w-full flex-col items-center justify-between gap-2 md:flex-row'>
                            <div className='text-c7'>
                                <div className='flex flex-col items-center gap-1 md:hidden'>
                                    <div>
                                        💰 <b>Airdrop! 11k+ tokens Weekly!</b>
                                    </div>
                                    <div>Join the Network & Claim your tokens Today!</div>
                                </div>
                                <div className='max-md:hidden'>
                                    💰 <b>Airdrop! 11k+ tokens Weekly!</b> — Join Now & Claim.
                                </div>
                            </div>
                            <div>
                                <a href='http://t.me/fossfiBot/join' target='_blank' rel='noopener noreferrer'>
                                    <button className='rounded-xl bg-c6 px-8 py-2 text-white'>Claim Now</button>
                                </a>
                            </div>
                        </div>
