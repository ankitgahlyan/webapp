...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* ─── Topbar ─── */}
      <header className="flex items-center justify-between px-7 h-15 border-b sticky top-0 z-50 bg-background max-sm:px-4 max-sm:h-auto max-sm:flex-wrap max-sm:gap-2.5 max-sm:py-3">
      ...
      {/* ─── Main content ─── */}
      <main className="flex-1 py-8 px-6 max-w-300 mx-auto w-full">
